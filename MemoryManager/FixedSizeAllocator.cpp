...
namespace MM
{
	...
	void FixedSizeAllocator::Chunk::Init(size_t blockSize, unsigned char blocks)
	{
	...
	void* FixedSizeAllocator::Chunk::Allocate(size_t blockSize)
	{
	...
	void FixedSizeAllocator::Chunk::Deallocate(void* p, size_t blockSize)
	{
		assert(p >= mData);
	...
	void FixedSizeAllocator::Chunk::Release()
	{
		delete[] mData;
	}
	...
	FixedSizeAllocator::FixedSizeAllocator(size_t blockSize)
	...
	FixedSizeAllocator::FixedSizeAllocator(const FixedSizeAllocator& a)
	...
	FixedSizeAllocator& FixedSizeAllocator::operator=(const FixedSizeAllocator& a)
	{
		FixedSizeAllocator copy(a);
		copy.Swap(*this);
		return *this;
	}
	...
	void FixedSizeAllocator::Swap(FixedSizeAllocator& a)
	{
	...
	FixedSizeAllocator::Chunk* FixedSizeAllocator::FindChunk(void* p)
	{
	...
	size_t FixedSizeAllocator::BlockSize() const
	{ 
		return mBlockSize; 
	}

	bool FixedSizeAllocator::operator<(size_t s) const
	{ 
		return BlockSize() < s; 
	}
